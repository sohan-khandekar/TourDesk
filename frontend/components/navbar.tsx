...
import { Menu, X, Ticket, Compass } from 'lucide-react';

const NAV = [
  { href: '/places?city=hyderabad', label: 'Explore Hyderabad' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <div className="leading-none">
            <span className={cn('block font-black text-lg tracking-tight', transparent ? 'text-white' : 'text-navy-900')}>
              TourDesk
            </span>
            <span className={cn('block text-[9px] font-semibold tracking-widest uppercase', transparent ? 'text-white/60' : 'text-slate-400')}>
              India Awaits
            </span>
          </div>
        </Link>
        ...
        <div className="md:hidden bg-white border-t border-slate-100 shadow-xl">
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="pt-3 border-t border-slate-100">
              <Link href="/places?city=hyderabad" onClick={() => setOpen(false)}
