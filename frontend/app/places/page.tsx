      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-3xl font-black text-white mb-1">
            {cityLabel} Tourist Places
          </h1>
          <p className="text-white/50 text-sm mb-5">
            {all.length} experiences &middot; Official ticket redirects &middot;
            Restaurant dish guides
          </p>
          ...
          <div className="flex items-center bg-white rounded-xl shadow-lg max-w-lg overflow-hidden">
            ...
            {search && (
              <button
                type="button"
                onClick={() => setSearch("")}
                className="px-3 text-slate-400 hover:text-slate-600 text-xs"
              >
                clear
              </button>
            )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          ...
          >
            <Heart
              size={14}
              className={showVisited ? "fill-orange-500 text-orange-500" : ""}
            />
