      ...
      <div className="max-w-2xl mx-auto px-4 py-28">
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-8 text-center">
          ...
          <h1 className="text-2xl font-black text-slate-900 mb-2">
            Bookings are handled officially
          </h1>
          <p className="text-slate-500 text-sm leading-relaxed mb-6">
            TourDesk no longer stores bookings or collects payments. Each
            attraction opens its own official portal, where ticket confirmation,
            refunds and slot changes are managed directly by the venue.
          </p>
          <Link
          ...
          <p className="text-xs text-slate-400 mt-5 flex items-center justify-center gap-1">
            <ExternalLink size={12} /> Keep your official portal confirmation
            safely after payment.
          </p>
        </div>
      </div>
    </div>
